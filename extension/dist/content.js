    ...
    return new Promise((resolve, reject) => {
        ...
        chrome.runtime.sendMessage(message, (response) => {
            if (chrome.runtime.lastError) {
                ...
                window.open(chrome.runtime.getURL(`popup/popup.html?text=${encodeURIComponent(message.text)}`), '_blank', 'width=400,height=500');
...
function createFlashcardButton(event) {
